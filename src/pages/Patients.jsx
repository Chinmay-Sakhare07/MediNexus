...
import { canManagePatients } from '../auth/permissions';
import { formatIstDate } from '../utils/datetime';
import { updatePatient } from '../services/api';
import { useState, useEffect } from 'react';
import { Plus, Search, Trash2, User, Pencil } from 'lucide-react';
...
export default function Patients() {
  ...
  const emptyForm = {
    ...
    phoneNumber: '', email: '', address: '', bloodType: '',
    emergencyContact: '', maritalStatus: 'Single', primaryPhysicianId: ''
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(editingId ? 'Patient updated successfully!' : 'Patient registered successfully!');
      setEditingId(null);
    } catch (error) {
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">
                        {formatIstDate(patient.dateOfBirth)}
                      </div>
                    </div>
                  </div>
                </td>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <h2 className="text-2xl font-bold mb-6">{editingId ? 'Edit Patient' : 'Register New Patient'}</h2>
